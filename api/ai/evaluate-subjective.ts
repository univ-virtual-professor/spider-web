...
const SYSTEM_INSTRUCTION = [
  ...
  "- NUMERICAL VERIFICATION (mandatory before scoring):",
  "  Extract every numerical value from the student's answer.",
  "  Compare each one against the corresponding value in the reference answer.",
  "  Any mismatch is a deduction — a wrong number loses marks even if the method or structure is correct.",
  "  Do not round, approximate, or overlook off-by-one differences; treat each number independently.",
